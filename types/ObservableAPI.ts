...
export class ObservablePetApi {
    ...
    public addPet(body: Pet, options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.addPet(body, options);
    ...
    public updatePet(body: Pet, options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.updatePet(body, options);
...
export class ObservableStoreApi {
     ...
     */
    public deleteOrder(orderId: number, options?: Configuration): Observable<void> {
    ...
    public placeOrder(body: Order, options?: Configuration): Observable<Order> {
        const requestContextPromise = this.requestFactory.placeOrder(body, options);
...
export class ObservableUserApi {
    ...
    public createUsersWithArrayInput(body: Array<User>, options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.createUsersWithArrayInput(body, options);
    ...
    public createUsersWithListInput(body: Array<User>, options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.createUsersWithListInput(body, options);
    ...
    public updateUser(username: string, body: User, options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.updateUser(username, body, options);
