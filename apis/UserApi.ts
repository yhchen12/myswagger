...
export class UserApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createUsersWithArrayInput(body: Array<User>, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param body List of user object
     */
    public async createUsersWithListInput(body: Array<User>, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     */
    public async updateUser(username: string, body: User, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
